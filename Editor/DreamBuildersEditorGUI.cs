...
namespace DreamBuilders.Editor
{
    public static class DreamBuildersEditorGUI
    {
        ...
        public static void PropertyField_Layout(SerializedProperty property, bool includeChildren) =>
            PropertyField_Implementation(new Rect(), property, includeChildren, DrawPropertyField_Layout);
        ...
        public static float GetIndentLength(Rect sourceRect) =>
            EditorGUI.IndentedRect(sourceRect).x - sourceRect.x;
            ...
            string label, int selectedValueIndex, object[] values, string[] displayOptions)
        {
            ...
            object newValue = values[EditorGUI.Popup(rect, label, selectedValueIndex, displayOptions)];
        ...
        public static void NonSerializedField_Layout(UnityEngine.Object target, FieldInfo field)
        {
            ...
            {
                string warning =
                    $"{nameof(ShowNonSerializedFieldAttribute)} doesn't support {field.FieldType.Name} types";
                HelpBox_Layout(warning, MessageType.Warning, target);
            }
        }
